...
res5() {
wget -q ${REPO}install/bbr.sh && chmod +x bbr.sh && ./bbr.sh
clear
}
res6() {
...
res10() {
wget -q ${REPO}install/protect-resource.sh && chmod +x protect-resource.sh && bash protect-resource.sh
clear
}
...
print_section_header "PROTECT RESOURCE"
res10
}
